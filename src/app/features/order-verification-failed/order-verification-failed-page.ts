    ...
    switch (this.reason()) {
      ...
      case 'missing-token':
        return {
          ...
          message:
            'Link koji ste otvorili nije kompletan. Otvorite najnoviji email sa potvrdom narudžbe.',
          primaryText: 'Nazad na početnu',
          primaryLink: '/',
          secondaryText: 'Otvori katalog',
          secondaryLink: '/catalog/muskarci/obuca',
      ...
      case 'invalid-token':
        return {
          ...
          message:
            'Link koji ste otvorili nije validan. Koristite najnoviji email sa potvrdom narudžbe.',
          primaryText: 'Nazad na početnu',
          primaryLink: '/',
          secondaryText: 'Otvori katalog',
          secondaryLink: '/catalog/muskarci/obuca',
