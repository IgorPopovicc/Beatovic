    ...
    switch (this.reason()) {
      ...
      case 'expired-token':
        return {
          ...
          message:
            'Link koji ste otvorili više nije važeći. Otvorite najnoviji newsletter email i pokušajte ponovo.',
          primaryText: 'Nazad na početnu',
          primaryLink: '/',
          secondaryText: 'Otvori katalog',
          secondaryLink: '/catalog/muskarci/obuca',
      ...
      case 'invalid-token':
        return {
          ...
          message:
            'Link koji ste otvorili nije validan. Otvorite najnoviji newsletter email i pokušajte ponovo.',
          primaryText: 'Nazad na početnu',
          primaryLink: '/',
          secondaryText: 'Otvori katalog',
          secondaryLink: '/catalog/muskarci/obuca',
